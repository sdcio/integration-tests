...
Partially Accept Deviation - ${operation} Patch intent4-srl applied on srl2
    ...
    ...    config
    ...    intent4-srl
    ...    '{"spec": {"config":[{"path":"/","value":{"interface":[{"admin-state":"disable","description":"Deviation revertive test - override description intent4","name":"ethernet-1/4","subinterface":[{"admin-state":"enable","index":0,"ipv4":{"address":[{"ip-prefix":"192.168.4.1/24"}],"admin-state":"enable","unnumbered":{"admin-state":"disable"}},"ipv6":{"address":[{"ip-prefix":"fd00:0:0:4::1/64"}],"admin-state":"enable"},"type":"routed","vlan":{"encap":{"single-tagged":{"vlan-id":400}}}}],"vlan-tagging":true}],"network-instance":[{"admin-state":"enable","description":"Intent4 Network-instance","interface":[{"name":"ethernet-1/4.0"}],"name":"vrf4","protocols":{"bgp":{"admin-state":"enable","afi-safi":[{"admin-state":"enable","afi-safi-name":"ipv4-unicast"},{"admin-state":"enable","afi-safi-name":"ipv6-unicast"}],"autonomous-system":65004,"router-id":"4.4.4.4"}},"type":"ip-vrf"}]}}],"priority":10}}'
...
Fully Accept Deviation - ${operation} Patch intent4-srl applied on srl2
    ...
    ...    config
    ...    intent4-srl
    ...    '{"spec": {"config":[{"path":"/","value":{"interface":[{"admin-state":"disable","description":"Deviation revertive test - override description intent4","name":"ethernet-1/4","subinterface":[{"admin-state":"enable","index":0,"ipv4":{"address":[{"ip-prefix":"192.168.4.1/24"}],"admin-state":"enable","unnumbered":{"admin-state":"disable"}},"ipv6":{"address":[{"ip-prefix":"fd00:0:0:4::1/64"}],"admin-state":"enable"},"type":"routed","vlan":{"encap":{"single-tagged":{"vlan-id":400}}}}],"vlan-tagging":true}],"network-instance":[{"admin-state":"disable","description":"Intent4 Network-instance","interface":[{"name":"ethernet-1/4.0"}],"name":"vrf4","protocols":{"bgp":{"admin-state":"enable","afi-safi":[{"admin-state":"enable","afi-safi-name":"ipv4-unicast"},{"admin-state":"disable","afi-safi-name":"ipv6-unicast"}],"autonomous-system":4000,"router-id":"4.4.4.4"}},"type":"ip-vrf"}]}}],"priority":10}}'
