...
${operation} - ConfigSet intent1 on ${SDCIO_SROS_NODES}
    ...
    ...    kubectl apply -f ${CURDIR}/sros/intent1-sros-replace.yaml
    Log    ${output}
...
${operation} - ConfigSet intent2 on ${SDCIO_SROS_NODES}
    Log    ${CURDIR}
    ${rc}    ${output} =    Run And Return Rc And Output
    ...    kubectl apply -f ${CURDIR}/sros/intent2-sros-replace.yaml
    Log    ${output}
    Should Be Equal As Integers    ${rc}    0
...
${operation} - Config intent3 on sr1
    Log    ${CURDIR}
    ${rc}    ${output} =    Run And Return Rc And Output
    ...    kubectl apply -f ${CURDIR}/sros/intent3-sros-replace.yaml
    Log    ${output}
    Should Be Equal As Integers    ${rc}    0
...
${operation} - Config intent4 on sr2
    Log    ${CURDIR}
    ${rc}    ${output} =    Run And Return Rc And Output
    ...    kubectl apply -f ${CURDIR}/sros/intent4-sros-replace.yaml
    Log    ${output}
    Should Be Equal As Integers    ${rc}    0
